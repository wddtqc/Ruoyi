<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="introList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="图片" align="center" prop="introImg" width="100">
        <template slot-scope="scope">
          <image-preview :src="scope.row.introImg" :width="50" :height="50"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="图片" prop="introImg">
              <image-upload v-model="form.introImg" :limit="1" :action="uploadAction"/>
            </el-form-item>
          </el-col>
          <el-col :span="24">
